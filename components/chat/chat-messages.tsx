...
export const ChatMessages = ({
    ...
    if(status === "pending"){
        return(
            ...
            >
                <Loader2 
                className="h-7 w-7 text-zinc-700 animate-spin my-4"
                />
                <p
    ...
    if(status === "error"){
        return(
            ...
            >
                <ServerCrash 
                className="h-7 w-7 text-zinc-700 my-4"
                />
                <p
                className="text-xs text-zinc-500 dark:text-zinc-400"
                >
    ...
    return(
        <div
        className="flex-1 flex-col py-4 overflow-y-auto"
        ref={chatRef}
        >
            ...
            )}
            {
                ...
                <div
                className="flex flex-col space-y-reverse mt-auto"
                >
